...
Time until Hospitalization (${t_{H}}$) & 4.49 (1.44) days & 4.63 (1.43) days s  \\
...
\includegraphics[width=.41\textwidth]{map}
\includegraphics[width=.59\textwidth]{time}
\end{frame}
