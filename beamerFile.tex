...
Parameter &  Before Intervention  & After Intervention & Fitted Values\\ [0.5ex]
 & (Mar 2014 to Sept 2014) &  (Sept 2014 to July 2015) & from \cite{Rivers2014}\\ [0.5ex] % inserts table
% inserts table
%heading
\hline % inserts single horizontal line
...
\begin{figure}[h!]
 ...
 \begin{subfigure}{\textwidth}
  \includegraphics[width=\textwidth]{LB_Int3a_SD_IM}  \label{fig:LB_IM_In1} \end{subfigure}
  \hspace{.1cm}
\begin{subfigure}{\textwidth}
 \includegraphics[width=\textwidth]{LB_Int3b_SD_IM}  \label{fig:LB_IM_In2} \end{subfigure} 
\label{fig:LB_IM_In} 
\end{figure}
\end{frame}
