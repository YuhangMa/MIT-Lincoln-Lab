The system-based and agent-based models use the same seven states and transitions. Here we present the seven-compartment model as well as the shared assumptions and parameters between the models.%Throughout the three models we utilize the same assumptions and compartment-state definitions. 
