...
\begin{figure}[!h]
  ...
  \caption{ Simulation results. \textit{A.} Parameters of the first stage (March 2014  to Sept 2014), \textit{B.} Parameters of the second stage ( Sept 2014 to July 2015)}
\label{fig:LB_IM_In} 
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption{ Comparison between World Health Organization (WHO) data and Insight Maker (IM) results using the parameters of A. the first stage (March 2014  to Sept 2014) and B. the second stage ( Sept 2014 to July 2015) for the cumulative deaths (D).}
\label{fig:LB_IM_WHO} 
\end{figure}
