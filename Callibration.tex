...
Based on our calibration, the intervention reduce the basic reproduction number of Ebola in Liberia from 1.99 to 0.787, using the formula in (reference). As a result, infection spread terminated after infection 0.84\% of total population and 0.49\% decrease in population, otherwise 92.7\% are infected and 53.5\% decrease in population.\\
