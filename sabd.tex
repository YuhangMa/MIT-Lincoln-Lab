...
\end{tabular}
%\caption{Parameter values used in the model. Values marked with $^\star$ are based on data from Table ??, which contains data from the parameter calibration and from [cite]. Other values were chosen heuristically.
\end{center}
\end{table}
